...
from dkmap.utils import get_random_string, entropy, distance_functions
...
class MapLoss(nn.Module):
    ...
    def forward(self, embeddings, scores, p_joint):
        ...
        return loss
def fit_dkmap_model(model: torch.nn.Module,
                    input_points: tensor,
                    opt: Optimizer,
    ...
    for epoch in range(n_epochs):
        ...
        save_path = "dkmap"+f"{model_name}_epoch_{epoch + 1}"
