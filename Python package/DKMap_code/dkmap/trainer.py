...
from dkmap.dk_model import NeuralMapper
from dkmap.dk_training import fit_dkmap_model, MapLoss


def train_parametric_dk_map_model(points_ds, input_dimens, config, scores):
    net = NeuralMapper
    ...
    model_path, a1, a2, b=fit_dkmap_model(ffnn,
                    points_ds,
                    opt,
